...
var Editor = {
  ...
  positions: function* positions(editor) {
    ...
    var _iterator6 = _createForOfIteratorHelper$1(Editor.nodes(editor, {
      at: at,
      reverse: reverse,
      voids: voids
    })),
...
var Text = {
  ...
  equals: function equals(text, another) {
    ...
    return isEqual__default['default'](loose ? omit__default['default'](text, 'text') : text, loose ? omit__default['default'](another, 'text') : another);
  },

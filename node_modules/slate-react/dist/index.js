...
var HAS_BEFORE_INPUT_SUPPORT = !IS_CHROME_LEGACY && !IS_EDGE_LEGACY && globalThis.InputEvent && // @ts-ignore The `getTargetRanges` property isn't recognized.
...
var ReactEditor = {
   ...
   */
  toSlatePoint: function toSlatePoint(editor, domPoint, extractMatch) {
    var _ref5 = extractMatch ? domPoint : normalizeDOMPoint(domPoint),
...
var withReact = function withReact(editor) {
  ...
  e.apply = function (op) {
    ...
    switch (op.type) {
      ...
      case 'set_node':
        {
          var _iterator = _createForOfIteratorHelper$1(slate.Editor.levels(e, {
            at: op.path
          })),
              _step;
      ...
      case 'move_node':
        {
          var _iterator3 = _createForOfIteratorHelper$1(slate.Editor.levels(e, {
  ...
  e.insertData = function (data) {
    ...
    if (text) {
      ...
      var _iterator4 = _createForOfIteratorHelper$1(lines),
          _step4;
